...
#   timestamp: 2023-06-28T14:16:15+00:00
...
class Properties(BaseModel):
    ...
    multi_numerical: Optional[MultiNumerical] = None
...
class MicroFeatureCollection(BaseModel):
    ...
    value_range: Optional[Dict[str, ValueRange]] = Field(None, title='Value Range')
    descriptive_fields: Optional[List[str]] = Field(None, title='Descriptive Fields')
    coordinatesystem: Optional[Coordinatesystem] = None
