...
from microjson.vt2pbf.mapbox.protobuf_3 import vector_tile_pb2

# TODO: Implement support for protobuf version >= 4
"""
if int(protobuf.__version__.split('.')[0]) < 4:
    from microjson.vt2pbf.mapbox.protobuf_3 import vector_tile_pb2
else:
    from mapbox_vector_tile.Mapbox import vector_tile_pb2
#    from microjson.vt2pbf.mapbox.protobuf_4 import vector_tile_pb2
"""
